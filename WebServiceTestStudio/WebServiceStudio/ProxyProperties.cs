namespace WebServiceStudio
{
    ...
    [Serializable]
    public class ProxyProperties : IEquatable<ProxyProperties>
    {
        ...
        private void InitAdditionalProperties(HttpWebClientProtocol proxy)
        {
            if (proxyTypeHandlers == null)
            {
                ...
                CustomHandler[] proxyProperties = null; //TODO: Configuration.MasterConfig.ProxyProperties;
        ...
        public bool Equals(ProxyProperties other)
        {
